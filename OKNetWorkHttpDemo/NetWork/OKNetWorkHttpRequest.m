...
+ (void)postDataWithParameters:(NSDictionary *)parameters interfaceUrlString:(NSString *)interfaceUrlString success:(void (^)(id responseObject))success failure:(void (^)(NSError *error))failure {
    ...
    [manager POST:interfaceUrlString parameters:parameters progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
...
+ (void)getDataWithParameters:(NSDictionary *)parameters interfaceUrlString:(NSString *)interfaceUrlString success:(void (^)(id responseObject))success failure:(void (^)(NSError *error))failure {
    ...
    [manager GET:interfaceUrlString parameters:parameters progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        if (success) {
            success(responseObject);
        }
...
#pragma mark - 上传图片
+ (void)postDataUploadWithParameters:(NSDictionary *)parameters interfaceUrlString:(NSString *)interfaceUrlString fileName:(NSString *)fileName fileType:(NSString *)fileTye imageData:(NSData *)imagedata     progress:(void (^)(NSProgress *))progress  success:(void (^)(id responseObject))success failure:(void (^)())failure{
    OKNetWorkHttpSessionManager *manager = [OKNetWorkHttpSessionManager sharedInstance];
    if (parameters == nil || ![parameters isKindOfClass:[NSDictionary class]]) {
        parameters = [NSMutableDictionary dictionary];
    }
