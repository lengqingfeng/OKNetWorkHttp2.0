...
+ (void)postDataUploadWithParameters:(NSDictionary *)parameters
                  interfaceUrlString:(NSString *)interfaceUrlString
                            fileName:(NSString *)fileName fileType:(NSString *)fileTye
